* Em relação a Terceira Questão, minha intenção era criar uma coluna de data para agrupa-los por data, uma coluna com a contagem dos blocos(Valor Final) e na terceira outra contagem dos blocos adicionando um dia, para comparar o que foi criado no dia anterior com o dia atual(Valor inicial)
* 
